        ...
        <div className="flex justify-between items-center h-20">
          ...
          <Link to="/" className="flex items-center space-x-4 group">
            <img 
              ...
              className="h-16 w-auto object-contain filter brightness-125 contrast-110 group-hover:scale-105 transition-all duration-300"
            />
            <div className="text-2xl sm:text-3xl font-comic text-yellow-400 font-bold group-hover:text-yellow-300 transition-colors duration-300">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <div className="flex items-center space-x-4 ml-6 pl-6 border-l border-red-500">
              ...
              >
                <Phone size={16} />
                <span className="text-sm font-medium">306-331-4802</span>
              </a>
              <a
